...
if ! $PYTHON -c "import pygame" 2>/dev/null || ! $PYTHON -c "import socketio" 2>/dev/null || ! $PYTHON -c "import OpenGL" 2>/dev/null || ! $PYTHON -c "import pywavefront" 2>/dev/null; then
